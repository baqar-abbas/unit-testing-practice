...
**Unit-Testing-Practice** is a simple project which is done for unit testing practice.
...
- **[Unit Testing with JavaScript & Jest]**
...
```sh
  cd my-folder
  git clone https://github.com/baqar-abbas/unit-testing-project
```
...
### Usage
Unit Testing Practice. To test functions for unit testing
